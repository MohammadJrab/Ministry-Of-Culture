    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                dropdown: cn("absolute inset-0 opacity-0 dark:bg-background", defaultClassNames.dropdown),
                caption_label: cn(
            ...
            components={{
                ...
                Chevron: ({className, orientation, ...props}) =>
                {
                    ...
                    {
                        return (
                            <IconChevronLeft className={cn("size-4 rtl:-scale-x-100", className)} {...props} />
                        )
                    }
