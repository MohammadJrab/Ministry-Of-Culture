        ...
        <section className="container mb-20 md:mb-0 mt-16 md:mt-32 min-h-screen relative flex flex-col justify-center lg:justify-start" id={"syrianStorySection"}>
            ...
            <Motion animation="fadeUp">
                <div className="flex gap-4 items-center mt-14 w-full justify-center lg:justify-center">
                    <div className="flex w-32 md:w-32 lg:w-full h-0.5 bg-[#B9A779]"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 justify-center gap-10 mx-auto mt-12 lg:mt-32 items-center">
                <Motion animation="slideLeft" className="flex flex-col justify-center items-center lg:items-start lg:ms-11 text-start lg:text-start">
                ...
                <Motion animation="slideRight" className="flex w-full lg:w-fit mx-auto flex-col-reverse lg:flex-col items-center lg:order-0 gap-4">
                    <Image
