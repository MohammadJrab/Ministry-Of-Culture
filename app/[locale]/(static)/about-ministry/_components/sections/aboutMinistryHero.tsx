    ...
    return (
        <section className="container min-h-screen relative flex flex-col lg:mt-20 justify-center lg:justify-start" id={"home"}>
            ...
            <Motion animation="stagger" trigger="onMount" className="grid grid-cols-1 lg:grid-cols-2 justify-center gap-20 mx-auto lg:mt-60 items-center">
                <MotionItem className="flex flex-col justify-center items-center lg:items-start lg:ms-11 lg:text-start">
                    <h3 className="text-xl text-gold  md:text-3xl text-start">
                        {t('aboutMinistry.hero.title')}
                    </h3>
                    <p className="text-4xl text-start text-foreground mt-5  leading-relaxed">
