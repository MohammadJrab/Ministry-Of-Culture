...
export default async function ContactUsSection() {
    ...
    return (
        <section className="container xl:max-w-[1200px] my-46 scroll-m-24" id={'contact-us'}>
            <div
                className="flex flex-col lg:flex-row items-stretch w-full shadow-lg rounded-3xl overflow-hidden relative">
