...
export default async function HeroSection() {
    ...
    return (
        ...
        >
            ...
            {/* Content Container */}
            <div className="relative z-10 container  flex flex-col items-center justify-center min-h-screen py-32">
                ...
                <ServerMotion animation="stagger" trigger="onMount" className="flex flex-col items-center justify-center gap-6 text-center">
                    ...
                    <ServerMotion animation="fadeOnly" trigger="onMount" className="shrink-0 mt-20">
                        <div className="flex gap-4 items-center bg-white/10 backdrop-blur-md px-6 py-3 rounded-full border border-white/20">
                            <p className="text-sm font-medium hidden sm:block text-white">{t('hero.followUs')}</p>
                            <div className="w-px h-6 hidden sm:block bg-white/30"></div>
