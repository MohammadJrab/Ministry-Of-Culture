...
export default async function VisionSection() {
    ...
    return (
        <section className={'pt-16 px-6 md:pt-0 mb-32  md:mb-24  w-full'}>
            <ServerMotion animation="scaleIn" className="flex relative justify-center items-center text-center">
                ...
                <h3 className="text-xl md:text-2xl leading-12 font-medium text-foreground max-w-6xl text-pretty ">
                    {t.rich('quote', {
